...
public class MainActivity3 extends AppCompatActivity implements ListFragment.OnSelectedInterface{// publiczna klasa MainActivity3 rozszerzenie działania aplikacji CompatActivity
    public static final String VIEWPAGER_FRAGMENT = "viewpager_fragment";//publiczna klasa statycznego finału biblioteki String  VIEWPAGER_FRAGMENT
    public static final String LIST_FRAGMENT = "viewpager_fragment";//publiczna klasa statycznego finału biblioteki String  LIST_FRAGMENT
...
if(savedFragment == null) {// jeśli zapisane fragment jest null
        ListFragment fragment = new ListFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.placeHolder, fragment, LIST_FRAGMENT);//dodanie LIST_FRAGMENT
