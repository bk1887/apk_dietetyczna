...
public class ListFragment extends Fragment {// publiczna klasa ListFragment rozszerzenie działania aplikacji Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
       OnSelectedInterface listener = (OnSelectedInterface) getActivity();
        ...
        View view = inflater.inflate(R.layout.fragment_list, container, false);//pobranie widoku layoutu z fragment_list
        RecyclerView recyclerView= (RecyclerView) view.findViewById(R.id.listRecyclerView);// wyświetlanie listy elementów o układzie
        ListAdapter listAdapter = new ListAdapter(listener);//dostarczanie nowych lub zmodyfikowanych danych do RecyclerView.Adapter i obsługuje wszystkie obliczenia różnic
        recyclerView.setAdapter(listAdapter);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(getActivity());//mierzenie i pozycjonowanie widoków elementów w RecyclerView
